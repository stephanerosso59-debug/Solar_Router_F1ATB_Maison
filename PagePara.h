      ...
      <div class="form">
        ...
        <div class="ligne" id="port_serie">
          ...
          <select id="Serie" onclick="checkDisabled();">
            ...
            <option value="1">Linky : RX=gpio 16, TX=gpio 17</option>
            <option value="2">JSY-MK-194T : RX=gpio 26, TX=gpio 27</option>
            <!-- PCB Maison : options 3,4,5 retirees (broches 18/19, 5/17, 21/22 = conflit LED/W5500/Triac) -->
          </select>
        </div>
        ...
        <div class="ligne" id="Analog">
          ...
          <select id="pUxI" onclick="checkDisabled();">
            ...
            <!-- PCB Maison : options 1,2,3 retirees (broche 32=OLED SCL, 33=Fan) -->
            <option value="4">UxI : Commun(35), U(36), I(39)</option>
          </select>
        </div>
