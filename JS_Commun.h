...
const char *ParaCommunJS = R"====(
  ...
  function SetHautBas(){
      ...
      S +="<div id='onglets2'><div class='Bonglet2 Bgeneraux'><a href='/Para'>Généraux</a></div><div class='Bonglet2 Bheure' ><a href='/Heure'>Heure</a></div><div class='Bonglet2 Bexport'><a href='/Export'>Import / Export</a></div>";
